...
usersPromptGrader = ChatGroq(model="llama3-70b-8192",temperature=0.5).with_structured_output(GradeUserPrompt)
usersPromptGradingChain = usersPromptGradingTemplate | usersPromptGrader

## Story Creation Chain 
storyCreator = ChatGroq(model="llama3-70b-8192",temperature=0.5).with_structured_output(Story)
storyCreationChain = storyCreationTemplate | storyCreator

## Scenes Creation Chain
scenesCreator = ChatGroq(model="llama3-70b-8192",temperature=0.5).with_structured_output(Scenes)
